...
public class TitleUtil {
    ...
    public static void sendSubtitle(Player player, String subtitle) {
        player.showTitle(Title.title(Component.empty(), ColorUtil.component(subtitle),
    ...
    public static void sendTitleSubtitle(Player player, String title, String subtitle) {
        player.showTitle(Title.title(ColorUtil.component(title), ColorUtil.component(subtitle),
